...
export default function Home({ searchQuery, sort = 'default', categoryId, categoryName, resolution, mobileOnly, animatedOnly, onSearch }) {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      if (animatedOnly) params.media_type   = 'animated'
      if (searchQuery) {
  ...
  }, [page, sort, searchQuery, categoryId, resolution, mobileOnly, animatedOnly, perPage])

  useEffect(() => {
    setPage(1)
    window.scrollTo({ top: 0, behavior: 'smooth' })
  }, [sort, searchQuery, categoryId, resolution, mobileOnly, animatedOnly])
